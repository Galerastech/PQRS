...
from src.components.select_date import Fecha
from src.components.dicts_para_ejemplos.pqrs_y_normas import peticiones

from styles.text_colors import color as colores


class RangoFechas_PQRS(ft.UserControl):
...
#region tabla
        ...
        self.form_respuesta = ft.TextField(
            label="Respuesta",
            value="",
            read_only=True,
            label_style=ft.TextStyle(color=colores.DEFAULT.value),
...
#region funciones
    ...
    def open_dialog(self, e):
        ...
        if peticion:
            ...
            self.form_respuesta.value = peticion["respuesta"]
