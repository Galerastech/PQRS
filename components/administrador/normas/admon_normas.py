...
from .form_normas import Form_normas
from .tabla_normas import Tabla_Normas


class Admon_Normas(ft.UserControl):
    def __init__(self, page: ft.Page):
        ...
        self.consulta = Tabla_Normas(page)
        self.formulario = Form_normas(page)

        self.consulta.visible = False
