...
class Formato_Menu(ft.UserControl):
    def __init__(self):
        ...
        self.residentes = create_card("R", "RESIDENTES",
                                    'Administrar base de datos de los residentes',
                                    colores.PRIMARY.value, colores.SECONDARY.value, height=500,
                                    on_hover=self.change_color)

        self.administracion = create_card("A", "ADMINISTRACION", "Administrar el sistema de PQRS",
        ...
        self.normas = create_card("N", "NORMAS", "Normas y politicas para la buena convivencia", colores.CONTENT.value,
